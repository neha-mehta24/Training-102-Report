...
import java.sql.*;
public class moddis extends ActionSupport implements ServletRequestAware
{
...
public void setServletRequest(HttpServletRequest request){
 ...
 String lowerage;
  ...
  String testrecommended;
    ...
    public String mod3()
    {
        String q="update disease_master set disease_name='" +diseasename+"', disease_known_name='" +diseasekname+"',description='"+description+"',lower_age_limit='"+lowerage+"',upper_age_limit='"+Upperage+"',symptoms='"+symptoms+"',test_recommended='"+testrecommended+"' where disease_Id=" +diseaseid;
        mypack.conn c1=new mypack.conn();
        try{
            c1.update(q);
        }catch(Exception e){}
        this.addActionMessage("Disease Details updated Successfully");
        return(SUCCESS);
    }}
